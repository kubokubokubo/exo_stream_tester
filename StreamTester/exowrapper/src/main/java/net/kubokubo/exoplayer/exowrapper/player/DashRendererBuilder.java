 ...
 */
public class DashRendererBuilder implements PlayerImpl.RendererBuilder {
    ...
    @Override
    public void buildRenderers(PlayerImpl player) {
    ...
    private static final class AsyncRendererBuilder
        ...
        public AsyncRendererBuilder(Context context, String userAgent, String url,
                                    MediaDrmCallback drmCallback, PlayerImpl player) {
            this.context = context;
            this.userAgent = userAgent;
            this.drmCallback = drmCallback;
            this.player = player;
        ...
        private void buildRenderers() {
            ...
            ChunkSampleSource audioSampleSource = new ChunkSampleSource(audioChunkSource, loadControl,
                    ...
                    PlayerImpl.TYPE_AUDIO);
            TrackRenderer audioRenderer = new MediaCodecAudioTrackRenderer(audioSampleSource,
                    drmSessionManager, true, mainHandler, player, AudioCapabilities.getCapabilities(context));


            // Invoke the callback.
            TrackRenderer[] renderers = new TrackRenderer[PlayerImpl.RENDERERS_COUNT];
            renderers[PlayerImpl.TYPE_VIDEO] = videoRenderer;
            renderers[PlayerImpl.TYPE_AUDIO] = audioRenderer;
